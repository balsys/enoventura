        ...
        >
          ...
          >
            ...
            <Tab
              ...
              :name="$str('tabenoventura', 'theme_enoventura')"
              :always-render="true"
            >
              <EnoventuraNewTabForm
                v-if="embeddedFormData.formFieldData.enoventura"
                :saved-form-field-data="embeddedFormData.formFieldData.enoventura"
                :file-form-field-data="embeddedFormData.fileData"
                :is-saving="isSaving"
                :context-id="embeddedFormData.contextId"
                :selected-tenant-id="selectedTenantId"
                :customizable-tenant-settings="customizableTenantCategorySettings('enoventura')"
                @mounted="setInitialTenantCategoryValues"
                @submit="submit"
              />
            </Tab>
...
import EnoventuraNewTabForm from "../../../components/theme_settings/EnoventuraNewTabForm";
